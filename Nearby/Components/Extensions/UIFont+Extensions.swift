...
extension UIFont {
    ...
    static var light16Font: UIFont {
        return .systemFont(ofSize: 16, weight: .light)
    }

    static var semibold18Font: UIFont {
        return .systemFont(ofSize: 18, weight: .semibold)
    }
    static var regular16Font: UIFont {
        return .systemFont(ofSize: 16, weight: .regular)
    }
    static var semibold16Font: UIFont {
    ...
    static var medium16Font: UIFont {
        return UIFont(name: "SFCompact-Thin", size: 15) ?? .systemFont(ofSize: 15, weight: .medium)
    }
